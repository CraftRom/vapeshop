    ...
    items: [
      {
        ...
        label: 'Відповіді на ключові слова в групах',
        bool: true,
        hint: 'Увімкнено — бот сам відповідає в групі, коли впізнає питання '
              + 'про доставку, оплату чи повернення. Вимкнено — мовчить, поки '
              + 'до нього не звернуться прямо через @: пряме звернення лишається '
              + 'робочим завжди. Вимикають зазвичай у робочому чаті, де розмова '
              + 'про доставку щоразу викликала довідку про доставку',
      },
      {
        key: 'admin_chat_id',
