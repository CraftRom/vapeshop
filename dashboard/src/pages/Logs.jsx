...
const STOREFRONT_EVENT_LABELS = {
  ...
  'storefront.api.retry': 'Повтор безпечного GET-запиту',
  ...
  'storefront.runtime.external_error': 'Помилка стороннього скрипта без деталей',
...
// Країна поруч з адресою навмисно: магазин возить лише по Україні, і
// звернення з-за кордону саме по собі варте другого погляду — а щоб
// його побачити, не мало б доводитись розгортати рядок.
const SUMMARY_FIELDS = ['method', 'path', 'status', 'durationMs', 'ip', 'country']
