...
c.post("/api/operators", json={"login":"dupop","password":"kvitka-sadok-2026"}, headers=A)
r.check(c.post("/api/operators", json={"login":"dupop","password":"kvitka-sadok-2026"}, headers=A).status_code == 409, "дубль логіна менеджера")
