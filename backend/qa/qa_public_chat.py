...
# Smart router тепер ставить false-positive дорожче за мовчання: слово
# «новинки» без питання/запиту не є достатнім наміром магазину.
r.check(faq.match("новинки кіно дивились", shop, public=True) is None,
        "побутові «новинки кіно» більше не запускають каталог")
