...
class Settings(BaseSettings):
    ...
    # Те саме, але окремо для робочого чату з замовленнями. Вимкнено за
    # замовчуванням: там працює команда, і довідка для клієнтів посеред
    # їхньої розмови — чистий шум.
    faq_admin_chat_enabled: bool = False
    # Припущена вага однієї позиції, кг. Точної ваги товарів у каталозі
    # немає, тож розрахунок і подається як приблизний.
    delivery_weight_per_item: float = 0.5
