...
class SupportThread:
    ...
    Один клієнт може мати багато окремих звернень. Закрите звернення
    лишається в історії назавжди, доки менеджер свідомо не видалить його,
    а наступний /ask створює нову стрічку.
    """
